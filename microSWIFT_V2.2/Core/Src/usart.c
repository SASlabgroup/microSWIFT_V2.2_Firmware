...
void HAL_UART_MspInit ( UART_HandleTypeDef *uartHandle )
{
  ...
  else if ( uartHandle->Instance == USART2 )
  {
    ...
    /**USART2 GPIO Configuration
     ...
     PA3     ------> USART2_RX
     */
    GPIO_InitStruct.Pin = AUX_UART_1_TX_Pin | AUX_UART_1_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if ( uartHandle->Instance == USART3 )
  {
    ...
    GPIO_InitStruct.Pin = AUX_UART_2_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART3;
    HAL_GPIO_Init (AUX_UART_2_TX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit ( UART_HandleTypeDef *uartHandle )
{
  ...
  else if ( uartHandle->Instance == USART2 )
  {
    ...
    /**USART2 GPIO Configuration
     ...
     PA3     ------> USART2_RX
     */
    HAL_GPIO_DeInit (GPIOA, AUX_UART_1_TX_Pin | AUX_UART_1_RX_Pin);
  ...
  else if ( uartHandle->Instance == USART3 )
  {
    ...
    HAL_GPIO_DeInit (AUX_UART_2_TX_GPIO_Port, AUX_UART_2_TX_Pin);
