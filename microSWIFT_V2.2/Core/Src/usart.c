...
void HAL_UART_MspInit ( UART_HandleTypeDef *uartHandle )
{
  ...
  else if ( uartHandle->Instance == USART2 )
  {
    ...
    handle_GPDMA1_Channel7.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT1
    ...
    handle_GPDMA1_Channel6.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT1
                                                        | DMA_DEST_ALLOCATED_PORT1;
  ...
  else if ( uartHandle->Instance == USART3 )
  {
    ...
    handle_GPDMA1_Channel2.Init.Request = GPDMA1_REQUEST_USART3_RX;
