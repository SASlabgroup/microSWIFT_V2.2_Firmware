...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : RTC_TIMESTAMP_1_Pin */
  ...
  /*Configure GPIO pins : PG0 PG3 PG4 PG5
                           PG6 PG7 PG8 PG9
                           PG10 PG12 PG13 PG14
                           PG15 */
  ...
  /*Configure GPIO pins : EXT_LED_RED_Pin EXT_LED_GREEN_Pin RTC_SPI_CS_Pin BUS_5V_FET_Pin */
  ...
  /*Configure GPIO pin : IRIDIUM_FET_Pin */
  GPIO_InitStruct.Pin = IRIDIUM_FET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(IRIDIUM_FET_GPIO_Port, &GPIO_InitStruct);
