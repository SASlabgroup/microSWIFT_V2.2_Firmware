...
void MX_GPIO_Init ( void )
{
  ...
  HAL_GPIO_WritePin (
      GPIOE,
      CT_FET_Pin | SPARE_GPIO2_Pin | SPARE_GPIO3_Pin | SPARE_GPIO0_Pin | SPARE_GPIO4_Pin
      | ACCELEROMETER_FET_Pin | SPARE_GPIO1_Pin | SPI3_CSn1_Pin | SPI3_CSn2_Pin | UART_LOGGER_EN_Pin
      | RF_SWITCH_EN_Pin | RF_SWITCH_VCTL_Pin,
      GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin (GPIOF, SPI1_CSn1_Pin | SPI1_CSn3_Pin | SPI2_CSn3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin (WDOG_OR_INPUT_GPIO_Port, WDOG_OR_INPUT_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin (GPIOD,
  EXT_LED_RED_Pin | EXT_LED_GREEN_Pin | RTC_TIMESTAMP_1_Pin | BUS_5V_FET_Pin,
                     GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PC13 PC14 PC15 PC2
   PC6 PC7 PC8 PC9
   PC10 PC11 PC12 */
  GPIO_InitStruct.Pin = GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_15 | GPIO_PIN_2 | GPIO_PIN_6
  ...
  /*Configure GPIO pins : PF2 PF3 PF4 PF5
   PF12 */
  GPIO_InitStruct.Pin = GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_12;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : SPI1_CSn1_Pin WDOG_OR_INPUT_Pin SPI1_CSn3_Pin SPI2_CSn3_Pin */
  GPIO_InitStruct.Pin = SPI1_CSn1_Pin | WDOG_OR_INPUT_Pin | SPI1_CSn3_Pin | SPI2_CSn3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init (GPIOF, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : PG0 PG4 PG5 PG6
   PG9 PG10 PG12 PG13
   PG14 PG15 */
  GPIO_InitStruct.Pin = GPIO_PIN_0 | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_9 | GPIO_PIN_10
  ...
  /*Configure GPIO pins : PB11 PB13 PB15 PB5
   PB6 PB7 PB8 PB9 */
  GPIO_InitStruct.Pin = GPIO_PIN_11 | GPIO_PIN_13 | GPIO_PIN_15 | GPIO_PIN_5 | GPIO_PIN_6
  ...
  /*Configure GPIO pins : PD11 PD15 PD1 PD2
   PD3 */
  GPIO_InitStruct.Pin = GPIO_PIN_11 | GPIO_PIN_15 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init (GPIOD, &GPIO_InitStruct);
