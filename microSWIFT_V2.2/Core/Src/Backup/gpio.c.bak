...
void MX_GPIO_Init ( void )
{
  ...
  HAL_GPIO_WritePin (
      GPIOE,
      CT_FET_Pin | GNSS_FET_Pin | IRIDIUM_FET_Pin | TEMP_FET_Pin | LIGHT_FET_Pin | SPARE_GPIO2_Pin
      | SPARE_GPIO3_Pin | SPARE_GPIO0_Pin | SPARE_GPIO4_Pin | ACCELEROMETER_FET_Pin
      | SPARE_GPIO1_Pin | SPI3_CSn1_Pin | SPI3_CSn2_Pin | SPI3_CSn3_Pin | RF_SWITCH_EN_Pin
      | RF_SWITCH_VCTL_Pin,
      GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin (GPIOC, TURBIDITY_FET_Pin | RTC_TIMESTAMP_4_Pin | RTC_TIMESTAMP_2_Pin,
                     GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin (GPIOB, RTC_TIMESTAMP_3_Pin | SPI2_CSn1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin (GPIOF, SPI1_CSn1_Pin | AS7341_GPIO_Pin | SPI1_CSn3_Pin | SPI2_CSn3_Pin,
                     GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin (GPIOD,
                     EXT_LED_RED_Pin | EXT_LED_GREEN_Pin | IRIDIUM_OnOff_Pin | BUS_5V_FET_Pin,
                     GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PEPin PEPin PEPin PEPin
   ...
   PEPin PEPin PEPin PEPin
   PEPin PEPin PEPin PEPin */
  GPIO_InitStruct.Pin = CT_FET_Pin | GNSS_FET_Pin | IRIDIUM_FET_Pin | TEMP_FET_Pin | LIGHT_FET_Pin
                        | SPARE_GPIO2_Pin | SPARE_GPIO3_Pin | SPARE_GPIO0_Pin | SPARE_GPIO4_Pin
                        | ACCELEROMETER_FET_Pin | SPARE_GPIO1_Pin | SPI3_CSn1_Pin | SPI3_CSn2_Pin
                        | SPI3_CSn3_Pin | RF_SWITCH_EN_Pin | RF_SWITCH_VCTL_Pin;
  ...
  GPIO_InitStruct.Pin = RTC_TIMESTAMP_3_Pin | SPI2_CSn1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : PG0 PG2 PG3 PG5
   PG6 PG7 PG12 */
  GPIO_InitStruct.Pin = GPIO_PIN_0 | GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_7
                        | GPIO_PIN_12;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : PD11 PD15 PD7 */
  GPIO_InitStruct.Pin = GPIO_PIN_11 | GPIO_PIN_15 | GPIO_PIN_7;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init (GPIOD, &GPIO_InitStruct);
  ...
  HAL_NVIC_SetPriority (EXTI12_IRQn, 15, 0);
