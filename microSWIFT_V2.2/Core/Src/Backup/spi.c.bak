...
void HAL_SPI_MspInit ( SPI_HandleTypeDef *spiHandle )
{
  ...
  else if ( spiHandle->Instance == SPI2 )
  {
    ...
    /**SPI2 GPIO Configuration
     ...
     PB15     ------> SPI2_MOSI
     */
    GPIO_InitStruct.Pin = AUX_SPI_1_SCK_Pin | AUX_SPI_1_MISO_Pin | AUX_SPI_1_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if ( spiHandle->Instance == SPI3 )
  {
    ...
    GPIO_InitStruct.Pin = AUX_SPI_2_SCK_Pin | AUX_SPI_2_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_SPI_MspDeInit ( SPI_HandleTypeDef *spiHandle )
{
  ...
  else if ( spiHandle->Instance == SPI2 )
  {
    ...
    /**SPI2 GPIO Configuration
     ...
     PB15     ------> SPI2_MOSI
     */
    HAL_GPIO_DeInit (GPIOB, AUX_SPI_1_SCK_Pin | AUX_SPI_1_MISO_Pin | AUX_SPI_1_MOSI_Pin);
  ...
  else if ( spiHandle->Instance == SPI3 )
  {
    ...
    HAL_GPIO_DeInit (GPIOG, AUX_SPI_2_SCK_Pin | AUX_SPI_2_MISO_Pin);
