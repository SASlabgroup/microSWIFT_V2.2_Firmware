...
void HAL_OSPI_MspInit ( OSPI_HandleTypeDef *ospiHandle )
{
  ...
  if ( ospiHandle->Instance == OCTOSPI1 )
  {
    ...
    /**OCTOSPI1 GPIO Configuration
     ...
     PA4     ------> OCTOSPIM_P1_NCS
     */
    GPIO_InitStruct.Pin = RAM_OCTOSPI_SIO_3_Pin | RAM_OCTOSPI_SIO_2_Pin | RAM_OCTOSPI_SIO_0_Pin
                          | RAM_OCTOSPI_SIO_1_Pin;
...
void HAL_OSPI_MspDeInit ( OSPI_HandleTypeDef *ospiHandle )
{
  ...
  if ( ospiHandle->Instance == OCTOSPI1 )
  {
    ...
    HAL_GPIO_DeInit (
        GPIOF,
        RAM_OCTOSPI_SIO_3_Pin | RAM_OCTOSPI_SIO_2_Pin | RAM_OCTOSPI_SIO_0_Pin
        | RAM_OCTOSPI_SIO_1_Pin | RAM_OCTOSPI_CLK_Pin);
