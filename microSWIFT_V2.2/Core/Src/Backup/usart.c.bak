...
static bool uart5_init_status = false;
static bool usart1_init_status = false;
static bool usart2_init_status = false;
static bool usart3_init_status = false;
static bool usart6_init_status = false;
// Weird bug where CubeMX doesn't generate the handle for GPDMA channel 1
...
void HAL_UART_MspInit ( UART_HandleTypeDef *uartHandle )
{
  ...
  else if ( uartHandle->Instance == UART4 )
  {
    ...
    handle_GPDMA1_Channel9.Init.Request = GPDMA1_REQUEST_UART4_TX;
    ...
    handle_GPDMA1_Channel9.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT0
                                                        | DMA_DEST_ALLOCATED_PORT0;
    ...
    handle_GPDMA1_Channel8.Init.Request = GPDMA1_REQUEST_UART4_RX;
    ...
    handle_GPDMA1_Channel8.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT0
                                                        | DMA_DEST_ALLOCATED_PORT0;
  ...
  else if ( uartHandle->Instance == UART5 )
  {
    ...
    /**UART5 GPIO Configuration
     ...
     PD2     ------> UART5_RX
     */
    GPIO_InitStruct.Pin = CT_UART_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART5;
    HAL_GPIO_Init (CT_UART_TX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = CT_UART_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART5;
    HAL_GPIO_Init (CT_UART_RX_GPIO_Port, &GPIO_InitStruct);

    /* UART5 DMA Init */
    /* GPDMA1_REQUEST_UART5_TX Init */
    handle_GPDMA1_Channel11.Instance = GPDMA1_Channel11;
    handle_GPDMA1_Channel11.Init.Request = GPDMA1_REQUEST_UART5_TX;
    ...
    handle_GPDMA1_Channel11.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT0
                                                         | DMA_DEST_ALLOCATED_PORT0;
    ...
    handle_GPDMA1_Channel10.Init.Request = GPDMA1_REQUEST_UART5_RX;
    ...
    handle_GPDMA1_Channel10.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT0
                                                         | DMA_DEST_ALLOCATED_PORT0;
  ...
  else if ( uartHandle->Instance == USART2 )
  {
    ...
    handle_GPDMA1_Channel3.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT0
                                                        | DMA_DEST_ALLOCATED_PORT0;
    ...
    handle_GPDMA1_Channel2.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT0
                                                        | DMA_DEST_ALLOCATED_PORT0;
  ...
  else if ( uartHandle->Instance == USART3 )
  {
    ...
    handle_GPDMA1_Channel4.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT0
                                                        | DMA_DEST_ALLOCATED_PORT0;
  ...
  else if ( uartHandle->Instance == USART6 )
  {
    ...
    /**USART6 GPIO Configuration
     ...
     PC9     ------> USART6_TX
     */
    GPIO_InitStruct.Pin = LOGGER_UART_RX_Pin | LOGGER_UART_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    handle_GPDMA1_Channel7.Init.Request = GPDMA1_REQUEST_USART6_TX;
    ...
    handle_GPDMA1_Channel7.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT0
                                                        | DMA_DEST_ALLOCATED_PORT0;
    ...
    handle_GPDMA1_Channel6.Init.Request = GPDMA1_REQUEST_USART6_RX;
    ...
    handle_GPDMA1_Channel6.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT0
                                                        | DMA_DEST_ALLOCATED_PORT0;
...
void HAL_UART_MspDeInit ( UART_HandleTypeDef *uartHandle )
{
  ...
  else if ( uartHandle->Instance == UART5 )
  {
    ...
    /**UART5 GPIO Configuration
     ...
     PD2     ------> UART5_RX
     */
    HAL_GPIO_DeInit (CT_UART_TX_GPIO_Port, CT_UART_TX_Pin);

    HAL_GPIO_DeInit (CT_UART_RX_GPIO_Port, CT_UART_RX_Pin);
  ...
  else if ( uartHandle->Instance == USART6 )
  {
    ...
    /**USART6 GPIO Configuration
     ...
     PC9     ------> USART6_TX
     */
    HAL_GPIO_DeInit (GPIOC, LOGGER_UART_RX_Pin | LOGGER_UART_TX_Pin);
