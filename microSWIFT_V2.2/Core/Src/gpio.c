...
void MX_GPIO_Init ( void )
{
  ...
  HAL_GPIO_WritePin (
      GPIOE,
      CT_FET_Pin | GNSS_FET_Pin | IRIDIUM_FET_Pin | TEMP_FET_Pin | LIGHT_FET_Pin | AUX_GPIO_1_Pin
      | AUX_GPIO_2_Pin | AUX_GPIO_3_Pin | AUX_GPIO_4_Pin | AUX_GPIO_5_Pin | AUX_GPIO_6_Pin
      | AUX_GPIO_7_Pin | AUX_GPIO_8_Pin | RF_SWITCH_EN_Pin | RF_SWITCH_VCTRL_Pin,
      GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin (
      GPIOC, TURBIDITY_FET_Pin | RTC_TIMESTAMP_4_Pin | RTC_TIMESTAMP_2_Pin | SD_D0_Pin | SD_CK_Pin,
      GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin (
      GPIOF,
      AUX_GPIO_9_Pin | AUX_GPIO_10_Pin | AUX_GPIO_11_Pin | AUX_GPIO_12_Pin | AUX_GPIO_13_Pin
      | AUX_GPIO_14_Pin,
      GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = CT_FET_Pin | GNSS_FET_Pin | IRIDIUM_FET_Pin | TEMP_FET_Pin | LIGHT_FET_Pin
                        | AUX_GPIO_1_Pin | AUX_GPIO_2_Pin | AUX_GPIO_3_Pin | AUX_GPIO_4_Pin
                        | AUX_GPIO_5_Pin | AUX_GPIO_6_Pin | AUX_GPIO_7_Pin | AUX_GPIO_8_Pin
                        | RF_SWITCH_EN_Pin | RF_SWITCH_VCTRL_Pin;
  ...
  /*Configure GPIO pins : PA4 PA8 PA11 PA12
   PA15 */
  GPIO_InitStruct.Pin = GPIO_PIN_4 | GPIO_PIN_8 | GPIO_PIN_11 | GPIO_PIN_12 | GPIO_PIN_15;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : PB1 PB14 PB4 PB5
   PB7 PB8 PB9 */
  GPIO_InitStruct.Pin = GPIO_PIN_1 | GPIO_PIN_14 | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_7 | GPIO_PIN_8
                        | GPIO_PIN_9;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init (GPIOB, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_11 | GPIO_PIN_12
                        | GPIO_PIN_13 | GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_3 | GPIO_PIN_4
                        | GPIO_PIN_7;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : PG2 PG3 PG4 PG5
   PG6 PG9 PG12 PG15 */
  GPIO_InitStruct.Pin = GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_9
                        | GPIO_PIN_12 | GPIO_PIN_15;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init (GPIOG, &GPIO_InitStruct);

  /*Configure GPIO pins : PC6 PC7 PC9 PC11 */
