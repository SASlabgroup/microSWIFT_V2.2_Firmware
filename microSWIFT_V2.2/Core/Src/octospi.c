...
void HAL_OSPI_MspInit ( OSPI_HandleTypeDef *ospiHandle )
{
  ...
  if ( ospiHandle->Instance == OCTOSPI1 )
  {
    ...
    handle_GPDMA1_Channel15.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT0
    ...
    handle_GPDMA1_Channel14.Init.Request = GPDMA1_REQUEST_OCTOSPI1;
    ...
    handle_GPDMA1_Channel14.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT0
                                                         | DMA_DEST_ALLOCATED_PORT0;
    ...
    __HAL_LINKDMA(ospiHandle, hdma, handle_GPDMA1_Channel14);
...
void HAL_OSPI_MspDeInit ( OSPI_HandleTypeDef *ospiHandle )
{
  ...
  if ( ospiHandle->Instance == OCTOSPI1 )
  {
    ...
    HAL_GPIO_DeInit (GPIOF,
                     FLASH_IO3_Pin | FLASH_IO2_Pin | FLASH_IO0_Pin | FLASH_IO1_Pin | FLASH_CLK_Pin);
