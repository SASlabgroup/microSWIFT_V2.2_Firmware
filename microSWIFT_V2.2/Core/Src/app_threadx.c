...
{
  if ( (string_ptr - &(error_message[0])) + strlen (sample_window_error) <= ERROR_MESSAGE_MAX_LENGTH )
  {
...
{
  if ( (string_ptr - &(error_message[0])) + strlen (memory_alloc_error) <= ERROR_MESSAGE_MAX_LENGTH )
  {
...
{
  if ( (string_ptr - &(error_message[0])) + strlen (flash_unknown_error) <= ERROR_MESSAGE_MAX_LENGTH )
  {
...
{
  if ( (string_ptr - &(error_message[0])) + strlen (flash_storage_full) <= ERROR_MESSAGE_MAX_LENGTH )
  {
...
{
  if ( (string_ptr - &(error_message[0])) + strlen (flash_program_error) <= ERROR_MESSAGE_MAX_LENGTH )
  {
