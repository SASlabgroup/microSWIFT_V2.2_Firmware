...
void    shared_i2c_register_io_functions ( generic_i2c_driver *driver_ptr,
                                             I2C_HandleTypeDef *i2c_handle, TX_SEMAPHORE *i2c_sema,
                                             i2c_init_fn init, i2c_deinit_fn deinit,
                                             i2c_read_fn override_read_fn,
                                             i2c_write_fn override_write_fn );
void    shared_i2c_set_timeout_ticks ( generic_i2c_driver *driver_ptr, ULONG tx_timeout_ticks,
                                       ULONG rx_timeout_ticks );
int32_t generic_i2c_read ( void *driver_ptr, uint8_t *read_buf, uint16_t size,
                             uint32_t timeout_ticks );
int32_t generic_i2c_write ( void *driver_ptr, const uint8_t *write_buf, uint16_t size,
                             uint32_t timeout_ticks );
