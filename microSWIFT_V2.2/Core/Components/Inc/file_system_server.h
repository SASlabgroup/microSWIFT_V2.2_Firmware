...
#define FILE_SYSTEM_LOG_LINE_MAX_WAIT_TICKS (TX_TIMER_TICKS_PER_SECOND)
#define FILE_SYSTEM_GNSS_VELOCITIES_MAX_WAIT_TICKS (TX_TIMER_TICKS_PER_SECOND * 10U)
#define FILE_SYSTEM_GNSS_TRACK_MAX_WAIT_TICKS (TX_TIMER_TICKS_PER_SECOND * 20U)
#define FILE_SYSTEM_TEMP_RAW_MAX_WAIT_TICKS TX_TIMER_TICKS_PER_SECOND
#define FILE_SYSTEM_CT_RAW_MAX_WAIT_TICKS TX_TIMER_TICKS_PER_SECOND
